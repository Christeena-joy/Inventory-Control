...
import DarkThemeCards from "./DarkThemeCards";
...
export const Homecards = () => {
    ...
    const totalPurchasesStyles = {
        card: {
            ...
            height: "150px", // Set the height of the card
            marginLeft: "60px",
            backgroundColor: "#45b670", // Set the background color to green
            color: "white", // Set the text color to white
        }
    };
        ...
        <Box sx={{ backgroundColor: '#ebf6ffb0', minHeight: '100vh' }}>
            ...
            <Container maxWidth="lg">
                ...
                <Grid container rowSpacing={0} columnSpacing={{xs:1,sm:1,md:1}} alignItems="flex-start">
                   ...
                   {/* <Grid item lg={6}>
                        <TotalSales totalSales={totalSales} styles={totalPurchasesStyles} />
    </Grid>*/}
